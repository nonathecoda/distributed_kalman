...
class Const_Pos_Model(KalmanFilter):
    '''
    constant velocity,
    constant yaw pitch roll angles.
    '''
    def __init__(self, std_dev_process_noise_q, measurement_noise_r, initial_pose, name = "cp"):
        self.name = name
    ...
    def dt(self, timestep):
        self.state_transition_matrix =  np.array([[1,    0,   0],
                                                  [0,    1,   0],
                                                  [0,    0,   1]])
